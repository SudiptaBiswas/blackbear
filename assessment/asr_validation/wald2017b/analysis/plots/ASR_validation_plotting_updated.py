...
def main():
    ...
    case_A1_000b_old, case_A1_001_old, case_A1_002_old, case_A1_003_old, case_A1_101_old, case_A1_102_old, case_A1_103_old, case_A1_202_old, case_A1_303_old, case_A1_111_old, case_A1_222_old, case_A1_211_old, case_A1_331_old, case_A1_321_old = define_dataframes(
        "~/Codes/blackbear/assessment/asr_validation/wald2017b/analysis/A1-000b/gold/A1-000b_out.csv",
        "~/Codes/blackbear/assessment/asr_validation/wald2017b/analysis/A1-001a/gold/A1-001a_out.csv",
        "~/Codes/blackbear/assessment/asr_validation/wald2017b/analysis/A1-002/gold/A1-002_out.csv",
        "~/Codes/blackbear/assessment/asr_validation/wald2017b/analysis/A1-003/gold/A1-003_out.csv",
        "~/Codes/blackbear/assessment/asr_validation/wald2017b/analysis/A1-101a/gold/A1-101a_out.csv",
        "~/Codes/blackbear/assessment/asr_validation/wald2017b/analysis/A1-102a/gold/A1-102a_out.csv",
        "~/Codes/blackbear/assessment/asr_validation/wald2017b/analysis/A1-103/gold/A1-103_out.csv",
        "~/Codes/blackbear/assessment/asr_validation/wald2017b/analysis/A1-202/gold/A1-202_out.csv",
        "~/Codes/blackbear/assessment/asr_validation/wald2017b/analysis/A1-303/gold/A1-303_out.csv",
        "~/Codes/blackbear/assessment/asr_validation/wald2017b/analysis/A1-111a/gold/A1-111a_out.csv",
        "~/Codes/blackbear/assessment/asr_validation/wald2017b/analysis/A1-222/gold/A1-222_out.csv",
        "~/Codes/blackbear/assessment/asr_validation/wald2017b/analysis/A1-211/gold/A1-211_out.csv",
        "~/Codes/blackbear/assessment/asr_validation/wald2017b/analysis/A1-331/gold/A1-331_out.csv",
        "~/Codes/blackbear/assessment/asr_validation/wald2017b/analysis/A1-321a/gold/A1-321a_out.csv",
    )
    ...
    case_A1_000b_new, case_A1_001_new, case_A1_002_new, case_A1_003_new, case_A1_101_new, case_A1_102_new, case_A1_103_new, case_A1_202_new, case_A1_303_new, case_A1_111_new, case_A1_222_new, case_A1_211_new, case_A1_331_new, case_A1_321_new = define_dataframes(
        "~/Codes/concrete/blackbear/assessment/asr_validation/wald2017b/analysis/A1-000b/gold/A1-000b_out.csv",
        "~/Codes/concrete/blackbear/assessment/asr_validation/wald2017b/analysis/A1-001a/gold/A1-001a_out.csv",
        "~/Codes/concrete/blackbear/assessment/asr_validation/wald2017b/analysis/A1-002/gold/A1-002_out.csv",
        "~/Codes/concrete/blackbear/assessment/asr_validation/wald2017b/analysis/A1-003/gold/A1-003_out.csv",
        "~/Codes/concrete/blackbear/assessment/asr_validation/wald2017b/analysis/A1-101a/gold/A1-101a_out.csv",
        "~/Codes/concrete/blackbear/assessment/asr_validation/wald2017b/analysis/A1-102a/gold/A1-102a_out.csv",
        "~/Codes/concrete/blackbear/assessment/asr_validation/wald2017b/analysis/A1-103/gold/A1-103_out.csv",
        "~/Codes/concrete/blackbear/assessment/asr_validation/wald2017b/analysis/A1-202/gold/A1-202_out.csv",
        "~/Codes/concrete/blackbear/assessment/asr_validation/wald2017b/analysis/A1-303/gold/A1-303_out.csv",
        "~/Codes/concrete/blackbear/assessment/asr_validation/wald2017b/analysis/A1-111a/gold/A1-111a_out.csv",
        "~/Codes/concrete/blackbear/assessment/asr_validation/wald2017b/analysis/A1-222/gold/A1-222_out.csv",
        "~/Codes/concrete/blackbear/assessment/asr_validation/wald2017b/analysis/A1-211/gold/A1-211_out.csv",
        "~/Codes/concrete/blackbear/assessment/asr_validation/wald2017b/analysis/A1-331/gold/A1-331_out.csv",
        "~/Codes/concrete/blackbear/assessment/asr_validation/wald2017b/analysis/A1-321a/gold/A1-321a_out.csv",
    )
    ...
    for ax, cl, sub in zip(AXES_LIST, COLOR_LINES_DASH, AXES):
        tmp_dat2 = simplify(case_A1_001_new, ax)
        plt.plot(
    ...
    plt.savefig("A1-001a_new2.png", bbox_inches='tight')
    ...
    plt.ylabel('Axial Expansion (\%)')
    plt.legend(frameon=False)
    plt.savefig("A1-000_new.png", bbox_inches='tight')
    ...
    plt.ylabel('Axial Expansion (%)')
    # plt.legend(frameon=False)
    plt.savefig("A1-002_new.png", bbox_inches='tight')
    ...
    plt.ylabel('Axial Expansion (%)')
    plt.legend(frameon=False)
    plt.savefig("A1-003_new.png", bbox_inches='tight')
    ...
    plt.ylabel('Axial Expansion (%)')
    # plt.legend(frameon=False)
    plt.savefig("A1-101a_new.png", bbox_inches='tight')
    ...
    plt.ylabel('Axial Expansion (%)')
    # plt.legend(frameon=False)
    plt.savefig("A1-101b_new.png", bbox_inches='tight')
    ...
    plt.ylabel('Axial Expansion (%)')
    # plt.legend(frameon=False)
    plt.savefig("A1-102a_new.png", bbox_inches='tight')
    ...
    plt.ylabel('Axial Expansion (%)')
    # plt.legend(frameon=False)
    plt.savefig("A1-103_new.png", bbox_inches='tight')
    ...
    plt.ylabel('Axial Expansion (%)')
    # plt.legend(frameon=False)
    plt.savefig("A1-202_new.png", bbox_inches='tight')
    ...
    plt.ylabel('Axial Expansion (%)')
    plt.legend(frameon=False)
    plt.savefig("A1-303_new.png", bbox_inches='tight')
    ...
    plt.ylabel('Axial Expansion (%)')
    # plt.legend(frameon=False)
    plt.savefig("A1-111a_new.png", bbox_inches='tight')
    ...
    plt.ylabel('Axial Expansion (%)')
    # plt.legend(frameon=False)
    plt.savefig("A1-211_new.png", bbox_inches='tight')
    ...
    plt.ylabel('Axial Expansion (%)')
    plt.legend(frameon=False)
    plt.savefig("A1-321a_new.png", bbox_inches='tight')
...
case_A1_002_old = pd.read_csv('~/Codes/blackbear/assessment/asr_validation/wald2017b/analysis/A1-002/gold/A1-002_out.csv')
case_A1_002_new = pd.read_csv('~/Codes/concrete/blackbear/assessment/asr_validation/wald2017b/analysis/A1-002/gold/A1-002_out.csv')
