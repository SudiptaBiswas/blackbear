...
def main():
    ...
    axs[0,0].plot(a1_001b_px.x, a1_001b_px.y, 'r*', label='x-direction (Experiment)', markersize=3)
    axs[0,0].plot(a1_001b_py.x, a1_001b_py.y, 'b*', label='y-direction (Experiment)', markersize=3)
    axs[0,0].plot(a1_001b_pz.x, a1_001b_pz.y, 'g*', label='z-direction (Experiment)', markersize=3)
    axs[0,0].set_title('A1-001')
    axs[0,0].set_ylim(0, 1)
    axs[0,0].set_ylabel('Axial Expansion (%)')
    # plt.xlabel('Time (days)')
    # plt.ylabel('Axial Expansion (%)')
    # plt.legend(frameon=False)
    ...
    for ax, cl, sub in zip(AXES_LIST, COLOR_LINES, AXES):
        ...
        print (tmp_dat)
        print(tmp_dat.time[37]/ TIME_DIV)
        print(tmp_dat[ax] / MEAN_DIV * 100)
        axs[0,1].plot(
            tmp_dat.time / TIME_DIV,
            tmp_dat[ax] / MEAN_DIV * 100,
            cl,
    ...
    print(a1_002_px)
    axs[0,1].plot(a1_002_px.x, a1_002_px.y, 'r*', label='Experiment-x', markersize=3)
    axs[0,1].plot(a1_002_py.x, a1_002_py.y, 'b*', label='Experiment-y', markersize=3)
    axs[0,1].plot(a1_002_pz.x, a1_002_pz.y, 'g*', label='Experiment-z', markersize=3)
    axs[0,1].set_title('A1-002')
    ...
    axs[0,2].plot(a1_003_px.x, a1_003_px.y, 'r*', label='Experiment-x', markersize=3)
    axs[0,2].plot(a1_003_py.x, a1_003_py.y, 'b*', label='Experiment-y', markersize=3)
    axs[0,2].plot(a1_003_pz.x, a1_003_pz.y, 'g*', label='Experiment-z', markersize=3)
    axs[0,2].set_title('A1-003')
    ...
    #         linewidth=2
    #     )
    # axs[1,0].plot(a1_101a_px.x, a1_101a_px.y, 'r*', label='Experiment-x', markersize=3)
    # axs[1,0].plot(a1_101a_py.x, a1_101a_py.y, 'b*', label='Experiment-y', markersize=3)
    # axs[1,0].plot(a1_101a_pz.x, a1_101a_pz.y, 'g*', label='Experiment-z', markersize=3)
    # axs[1,0].set_title('A1-101a')
    ...
    axs[0,3].plot(a1_101b_px.x, a1_101b_px.y, 'r*', label='Experiment-x', markersize=3)
    axs[0,3].plot(a1_101b_py.x, a1_101b_py.y, 'b*', label='Experiment-y', markersize=3)
    axs[0,3].plot(a1_101b_pz.x, a1_101b_pz.y, 'g*', label='Experiment-z', markersize=3)
    axs[0,3].set_title('A1-101')
    axs[0,3].set_ylim(0,1)
    # axs[0,3].set_ylabel('Axial Expansion (%)')
    # plt.xlabel('Time (days)')
    # plt.ylabel('Axial Expansion (%)')
    # # plt.legend(frameon=False)
    ...
    axs[1,0].plot(a1_102_px.x, a1_102_px.y, 'r*', label='Experiment-x', markersize=3)
    axs[1,0].plot(a1_102_py.x, a1_102_py.y, 'b*', label='Experiment-y', markersize=3)
    axs[1,0].plot(a1_102_pz.x, a1_102_pz.y, 'g*', label='Experiment-z', markersize=3)
    axs[1,0].set_title('A1-102')
    axs[1,0].set_ylim(0,1)
    axs[1,0].set_ylabel('Axial Expansion (%)')
    ...
    axs[1,1].plot(a1_103_px.x, a1_103_px.y, 'r*', label='Experiment-x', markersize=3)
    axs[1,1].plot(a1_103_py.x, a1_103_py.y, 'b*', label='Experiment-y', markersize=3)
    axs[1,1].plot(a1_103_pz.x, a1_103_pz.y, 'g*', label='Experiment-z', markersize=3)
    axs[1,1].set_title('A1-103')
    axs[1,1].set_ylim(0,1)
    # axs[1,2].xlabel('Time (days)')
    # axs[1,2].ylabel('Axial Expansion (%)')
    # plt.legend(frameon=False)
    ...
    axs[1,2].plot(a1_202_px.x, a1_202_px.y, 'r*', label='Experiment-x', markersize=3)
    axs[1,2].plot(a1_202_py.x, a1_202_py.y, 'b*', label='Experiment-y', markersize=3)
    axs[1,2].plot(a1_202_pz.x, a1_202_pz.y, 'g*', label='Experiment-z', markersize=3)
    axs[1,2].set_title('A1-202')
    axs[1,2].set_ylim(0,1)
    axs[1,2].set_ylabel('Axial Expansion (%)')
    # plt.xlabel('Time (days)')
    # plt.ylabel('Axial Expansion (%)')
    # # plt.legend(frameon=False)
    ...
    axs[1,3].plot(a1_303_px.x, a1_303_px.y, 'r*', label='Experiment-x', markersize=3)
    axs[1,3].plot(a1_303_py.x, a1_303_py.y, 'b*', label='Experiment-y', markersize=3)
    axs[1,3].plot(a1_303_pz.x, a1_303_pz.y, 'g*', label='Experiment-z', markersize=3)
    axs[1,3].set_title('A1-303')
    axs[1,3].set_ylim(0,1)
    # axs[2,1].xlabel('Time (days)')
    # plt.ylabel('Axial Expansion (%)')
    # plt.legend(frameon=False)
    ...
    axs[2,0].plot(a1_111a_px.x, a1_111a_px.y, 'r*', label='Experiment-x', markersize=3)
    axs[2,0].plot(a1_111a_py.x, a1_111a_py.y, 'b*', label='Experiment-y', markersize=3)
    axs[2,0].plot(a1_111a_pz.x, a1_111a_pz.y, 'g*', label='Experiment-z', markersize=3)
    axs[2,0].set_title('A1-111')
    axs[2,0].set_ylim(0,1)
    axs[2,0].set_ylabel('Axial Expansion (%)')
    ...
    #         linewidth=2
    #     )
    # axs[3,1].plot(a1_111b_px.x, a1_111b_px.y, 'r*', label='Experiment-x', markersize=3)
    # axs[3,1].plot(a1_111b_py.x, a1_111b_py.y, 'b*', label='Experiment-y', markersize=3)
    # axs[3,1].plot(a1_111b_pz.x, a1_111b_pz.y, 'g*', label='Experiment-z', markersize=3)
    # axs[3,1].set_title('A1-111b')
    ...
    axs[2,1].plot(a1_211_px.x, a1_211_px.y, 'r*', label='Experiment-x', markersize=3)
    axs[2,1].plot(a1_211_py.x, a1_211_py.y, 'b*', label='Experiment-y', markersize=3)
    axs[2,1].plot(a1_211_pz.x, a1_211_pz.y, 'g*', label='Experiment-z', markersize=3)
    axs[2,1].set_title('A1-211')
    axs[2,1].set_ylim(0,1)
    # axs[2,2].set_ylabel('Axial Expansion (%)')
    ...
    #         linewidth=2
    #     )
    # plt.plot(a1_222_px.x, a1_222_px.y, 'r*', label='Experiment-x', markersize=3)
    # plt.plot(a1_222_py.x, a1_222_py.y, 'b*', label='Experiment-y', markersize=3)
    # plt.plot(a1_222_pz.x, a1_222_pz.y, 'g*', label='Experiment-z', markersize=3)
    # plt.xlabel('Time (days)')
    # plt.ylabel('Axial Expansion (%)')
    # # plt.legend(frameon=False)
    ...
    axs[2,2].plot(a1_331_px.x, a1_331_px.y, 'r*', label='Experiment-x', markersize=3)
    axs[2,2].plot(a1_331_py.x, a1_331_py.y, 'b*', label='Experiment-y', markersize=3)
    axs[2,2].plot(a1_331_pz.x, a1_331_pz.y, 'g*', label='Experiment-z', markersize=3)
    axs[2,2].set_title('A1-331')
    ...
    axs[2,3].plot(a1_321_px.x, a1_321_px.y, 'r*', label='Experiment-x', markersize=3)
    axs[2,3].plot(a1_321_py.x, a1_321_py.y, 'b*', label='Experiment-y', markersize=3)
    axs[2,3].plot(a1_321_pz.x, a1_321_pz.y, 'g*', label='Experiment-z', markersize=3)
    axs[2,3].set_title('A1-321')
    ...
    axs[3,0].plot(a3_102_px.x, a3_102_px.y, 'r*', label='Experiment-x', markersize=3)
    axs[3,0].plot(a3_102_py.x, a3_102_py.y, 'b*', label='Experiment-y', markersize=3)
    axs[3,0].plot(a3_102_pz.x, a3_102_pz.y, 'g*', label='Experiment-z', markersize=3)
    axs[3,0].set_ylim(0,1)
    axs[3,0].set_xlabel('Time (days)')
    axs[3,0].set_ylabel('Axial Expansion (%)')
    axs[3,0].set_title('A3-102')
    # plt.legend(frameon=False)
    ...
    axs[3,1].plot(a3_102_L1_px.x, a3_102_L1_px.y, 'r*', label='Experiment-x', markersize=3)
    axs[3,1].plot(a3_102_L1_py.x, a3_102_L1_py.y, 'b*', label='Experiment-y', markersize=3)
    axs[3,1].plot(a3_102_L1_pz.x, a3_102_L1_pz.y, 'g*', label='Experiment-z', markersize=3)
    axs[3,1].set_ylim(0,1)
    axs[3,1].set_xlabel('Time (days)')
    axs[3,1].set_title('A3-102-L1')
    # plt.legend(frameon=False)
    ...
    axs[3,2].plot(a3_202_L2_px.x, a3_202_L2_px.y, 'r*', label='Experiment-x', markersize=3)
    axs[3,2].plot(a3_202_L2_py.x, a3_202_L2_py.y, 'b*', label='Experiment-y', markersize=3)
    axs[3,2].plot(a3_202_L2_pz.x, a3_202_L2_pz.y, 'g*', label='Experiment-z', markersize=3)
    axs[3,2].set_ylim(0,1)
    axs[3,2].set_xlabel('Time (days)')
    axs[3,2].set_title('A3-202-L2')
    # plt.legend(frameon=False)
    ...
    axs[3,3].plot(a3_202_L3_px.x, a3_202_L3_px.y, 'r*', label='x', markersize=3)
    axs[3,3].plot(a3_202_L3_py.x, a3_202_L3_py.y, 'b*', label='y', markersize=3)
    axs[3,3].plot(a3_202_L3_pz.x, a3_202_L3_pz.y, 'g*', label='z', markersize=3)
    axs[3,3].set_ylim(0,1)
    axs[3,3].set_xlabel('Time (days)')
    axs[3,3].set_title('A3-202-L3')
    # plt.legend(frameon=False)
    # plt.savefig("A3-202-L3.png", bbox_inches='tight')
    # plt.close()

    handles, labels = axs[0][0].get_legend_handles_labels()
    fig.legend(flip(handles, 3), flip(labels, 3), loc='upper center', frameon=False, ncol=3)
    for ax in axs.flat:
      ax.label_outer()
    fig.savefig("ASR_block_combined2.pdf", bbox_inches='tight')
    ...
    ax1.plot(case_A1_002.iloc[1:]['time']/86400, case_A1_002.iloc[1:]['temp'], 'r-',label='Average response from simulation', markersize = 5, linewidth=2)
    ...
    ax2.plot(case_A1_002.iloc[1:]['time']/86400, case_A1_002.iloc[1:]['humidity']*100, 'r-', label='Average response from simulation', markersize = 5, linewidth=2)
    ax2.set_xlim(0,)
    ax2.set_ylim(0,)
