...
def main():
    ...
    case_A1_000b_new, case_A1_001_new, case_A1_002_new, case_A1_003_new, case_A1_101_new, case_A1_102_new, case_A1_103_new, case_A1_202_new, case_A1_303_new, case_A1_111_new, case_A1_222_new, case_A1_211_new, case_A1_331_new, case_A1_321_new,case_A3_102_new, case_A3_102_L1_new, case_A3_202_L2_new, case_A3_202_L3_new = define_dataframes(
        "./A1-000b_out.csv",
        "./A1-001a_out.csv",
        "./A1-002_out.csv",
        "./A1-003_out.csv",
    ...
    case_A3_102_new = compute_displacements(case_A3_102_new)
    case_A3_102_L1_new = compute_displacements(case_A3_102_L1_new)
    case_A3_202_L2_new = compute_displacements(case_A3_202_L2_new)
    case_A3_202_L3_new = compute_displacements(case_A3_202_L3_new)
    ...
    for ax, cl, sub in zip(AXES_LIST, COLOR_LINES_DASH, AXES):
        tmp_dat2 = simplify(case_A1_331_new, ax)
        plt.plot(
            tmp_dat2.time / TIME_DIV,
            tmp_dat2[ax] / MEAN_DIV * 100,
            cl,
    ...
    for ax, cl, sub in zip(AXES_LIST, COLOR_LINES_DASH, AXES):
     tmp_dat = simplify(case_A3_102_L1_new, ax)
     plt.plot(
         (tmp_dat.time - tmp_dat.time[0]) / TIME_DIV + 27,
         tmp_dat[ax] / MEAN_DIV * 100,
         cl,
