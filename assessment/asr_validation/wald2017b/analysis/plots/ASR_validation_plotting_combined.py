...
def main():
    ...
    plt.subplots_adjust(left=0.1, bottom=0.07, right=0.9, top=0.92)
    for ax, cl, sub in zip(AXES_LIST, COLOR_LINES, AXES):
    ...
    axs[1,0].plot(a1_101b_px.x, a1_101b_px.y, 'r*', label='Experiment-x', markersize=3)
    axs[1,0].plot(a1_101b_py.x, a1_101b_py.y, 'b*', label='Experiment-y', markersize=3)
    axs[1,0].plot(a1_101b_pz.x, a1_101b_pz.y, 'g*', label='Experiment-z', markersize=3)
    axs[1,0].set_title('A1-101')
    ...
    axs[1,1].plot(a1_102_px.x, a1_102_px.y, 'r*', label='Experiment-x', markersize=3)
    axs[1,1].plot(a1_102_py.x, a1_102_py.y, 'b*', label='Experiment-y', markersize=3)
    axs[1,1].plot(a1_102_pz.x, a1_102_pz.y, 'g*', label='Experiment-z', markersize=3)
    axs[1,1].set_title('A1-102')
    ...
    axs[1,2].plot(a1_103_px.x, a1_103_px.y, 'r*', label='Experiment-x', markersize=3)
    axs[1,2].plot(a1_103_py.x, a1_103_py.y, 'b*', label='Experiment-y', markersize=3)
    axs[1,2].plot(a1_103_pz.x, a1_103_pz.y, 'g*', label='Experiment-z', markersize=3)
    axs[1,2].set_title('A1-103')
    axs[1,2].set_ylim(0,1)
    # axs[2,0].xlabel('Time (days)')
    # axs[2,0].ylabel('Axial Expansion (%)')
    # plt.legend(frameon=False)
    ...
    axs[2,0].plot(a1_202_px.x, a1_202_px.y, 'r*', label='Experiment-x', markersize=3)
    axs[2,0].plot(a1_202_py.x, a1_202_py.y, 'b*', label='Experiment-y', markersize=3)
    axs[2,0].plot(a1_202_pz.x, a1_202_pz.y, 'g*', label='Experiment-z', markersize=3)
    axs[2,0].set_title('A1-202')
    ...
    axs[2,1].plot(a1_303_px.x, a1_303_px.y, 'r*', label='Experiment-x', markersize=3)
    axs[2,1].plot(a1_303_py.x, a1_303_py.y, 'b*', label='Experiment-y', markersize=3)
    axs[2,1].plot(a1_303_pz.x, a1_303_pz.y, 'g*', label='Experiment-z', markersize=3)
    axs[2,1].set_title('A1-303')
    axs[2,1].set_ylim(0,1)
    # axs[2,2].xlabel('Time (days)')
    # plt.ylabel('Axial Expansion (%)')
    # plt.legend(frameon=False)
    ...
    axs[2,2].plot(a1_111a_px.x, a1_111a_px.y, 'r*', label='Experiment-x', markersize=3)
    axs[2,2].plot(a1_111a_py.x, a1_111a_py.y, 'b*', label='Experiment-y', markersize=3)
    axs[2,2].plot(a1_111a_pz.x, a1_111a_pz.y, 'g*', label='Experiment-z', markersize=3)
    axs[2,2].set_title('A1-111')
    ...
    axs[3,0].plot(a1_211_px.x, a1_211_px.y, 'r*', label='Experiment-x', markersize=3)
    axs[3,0].plot(a1_211_py.x, a1_211_py.y, 'b*', label='Experiment-y', markersize=3)
    axs[3,0].plot(a1_211_pz.x, a1_211_pz.y, 'g*', label='Experiment-z', markersize=3)
    axs[3,0].set_title('A1-211')
    ...
    axs[3,1].plot(a1_331_px.x, a1_331_px.y, 'r*', label='Experiment-x', markersize=3)
    axs[3,1].plot(a1_331_py.x, a1_331_py.y, 'b*', label='Experiment-y', markersize=3)
    axs[3,1].plot(a1_331_pz.x, a1_331_pz.y, 'g*', label='Experiment-z', markersize=3)
    axs[3,1].set_title('A1-331')
    ...
    axs[3,2].plot(a1_321_px.x, a1_321_px.y, 'r*', label='Experiment-x', markersize=3)
    axs[3,2].plot(a1_321_py.x, a1_321_py.y, 'b*', label='Experiment-y', markersize=3)
    axs[3,2].plot(a1_321_pz.x, a1_321_pz.y, 'g*', label='Experiment-z', markersize=3)
    axs[3,2].set_title('A1-321')
    ...
    for ax in axs.flat:
      ax.label_outer()
    fig.savefig("ASR_block_combined.pdf", bbox_inches='tight')
    ...
    plt.plot(a3_102_px.x, a3_102_px.y, 'r*', label='Experiment-x', markersize=3)
    plt.plot(a3_102_py.x, a3_102_py.y, 'b*', label='Experiment-y', markersize=3)
    plt.plot(a3_102_pz.x, a3_102_pz.y, 'g*', label='Experiment-z', markersize=3)
    plt.xlabel('Time (days)')
    plt.ylabel('Axial Expansion (%)')
    ax.set_title('A3-102')
    # plt.legend(frameon=False)
    ...
    plt.plot(a3_102_L1_px.x, a3_102_L1_px.y, 'r*', label='Experiment-x', markersize=3)
    plt.plot(a3_102_L1_py.x, a3_102_L1_py.y, 'b*', label='Experiment-y', markersize=3)
    plt.plot(a3_102_L1_pz.x, a3_102_L1_pz.y, 'g*', label='Experiment-z', markersize=3)
    plt.xlabel('Time (days)')
    plt.ylabel('Axial Expansion (%)')
    ax.set_title('A3-102-L1')
    # plt.legend(frameon=False)
    ...
    plt.plot(a3_202_L2_px.x, a3_202_L2_px.y, 'r*', label='Experiment-x', markersize=3)
    plt.plot(a3_202_L2_py.x, a3_202_L2_py.y, 'b*', label='Experiment-y', markersize=3)
    plt.plot(a3_202_L2_pz.x, a3_202_L2_pz.y, 'g*', label='Experiment-z', markersize=3)
    plt.xlabel('Time (days)')
    plt.ylabel('Axial Expansion (%)')
    ax.set_title('A3-202-L2')
    # plt.legend(frameon=False)
    ...
    plt.plot(a3_202_L3_px.x, a3_202_L3_px.y, 'r*', label='x', markersize=3)
    plt.plot(a3_202_L3_py.x, a3_202_L3_py.y, 'b*', label='y', markersize=3)
    plt.plot(a3_202_L3_pz.x, a3_202_L3_pz.y, 'g*', label='z', markersize=3)
    plt.xlabel('Time (days)')
    plt.ylabel('Axial Expansion (%)')
    ax.set_title('A3-202-L3')
    # plt.legend(frameon=False)
