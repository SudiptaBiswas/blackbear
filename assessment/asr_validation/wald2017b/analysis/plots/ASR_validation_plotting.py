...
def main():
    ...
    case_A1_002_old = pd.read_csv('../A1-000b/gold/A1-000b_out.csv') # pick any output file
    ...
    ax1.plot(case_A1_002_old.iloc[1:]['time']/86400, case_A1_002_old.iloc[1:]['temp'], 'm-',label='Average response from old simulation', markersize = 5, linewidth=3)
    ax1.plot(case_A1_002.iloc[1:]['time']/86400, case_A1_002.iloc[1:]['temp'], 'g-',label='Average response from new simulation', markersize = 5, linewidth=3)
    ...
    ax2.plot(case_A1_002_old.iloc[1:]['time']/86400, case_A1_002_old.iloc[1:]['humidity']*100, 'm-', label='Average response from old simulation', markersize = 5, linewidth=3)
    ax2.plot(case_A1_002.iloc[1:]['time']/86400, case_A1_002.iloc[1:]['humidity']*100, 'g-', label='Average response from new simulation', markersize = 5, linewidth=3)
    ax2.set_xlim(0,)
    ax2.set_ylim(0,)
